...
@Data
@Schema(description = "Response DTO containing member details")
public class MemberResponseDto {
    ...
    @Schema(description = "Membership number assigned to the member", example = "MEMB2023001")
    private String membershipNumber;

    @Schema(description = "Current force number of the member", example = "123456")
    private String forceNumber;

    @Schema(description = "Previous force number of the member", example = "654321")
    ...
    @Schema(description = "Monthly tax deductions", example = "100.00")
    private Double tax;

    @Schema(description = "Personal details of the member")
    private PersonalDetails personalDetails;

    @Schema(description = "Audit trail metadata for the member")
    private Audit audit;
}
